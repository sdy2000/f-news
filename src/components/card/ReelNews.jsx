...
const ReelNews = ({ news }) => {
    return (
        <Link className='relative hover:scale-105 ease-in-out duration-500 bg-p rounded-lg overflow-hidden' to='#'>
            <img
            ...
            <div className='flex flex-col justify-start gap-3 py-2 px-3 break-all'>
                <h3 className='text-p text-lg font-semibold xl:text-xl'>
                    {news.title}
                </h3>
